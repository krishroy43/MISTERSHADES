page 50055 "Opearation With Job RC"
{
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            group(SetupAndExtensions)
            {
                ...
                //     RunObject = Page "Business Setup";
                //     RunPageView = SORTING (Name) WHERE (Area = FILTER ("Fixed Assets"));
                ...
                //     RunObject = Page "Automation Extensions Entity";
