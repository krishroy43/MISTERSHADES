report 50233 "Sales Proforma Invoice NOJOB"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            { }
            column(PaymentTerm; PaymentTerm.Code)
            { }
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                {
                    ...
                    begin
                        if "Document No." <> ' ' then
                            TotalInvoiceAmountWithoutTax += (Amount - (Amount * "Sales Line"."VAT %") / 100);
                    end;
                ...
                begin
                    ...
                    AmountInWordCodeunitCU.FormatNoText(AmountInWordForWithoutJob, ((("Sales Header"."Work Done" * "VAT %") / 100) + "Sales Header"."Work Done"), CurrCode);
            ...
            begin
                ...
                if (SalesLineRec.FindFirst()) and (SalesHEader = 0) then begin
                    ...
                    FinalAmountIncludingVAT := FindFinalAmount__RDLC("Sales Header"."No.");
                    AmountInWordCodeunitCU.InitTextVariable();
                    AmountInWordCodeunitCU.FormatNoText(AmountInWordForJob, FinalAmountIncludingVAT, CurrCode);
    ...
    begin
        ...
        if salesHeaderRec.Get(salesHeaderRec."Document Type"::Invoice, DocNo) then begin
            ...
            if SalesLineRec.FindFirst() then
                repeat
                    FinalAmountIncludingVAT += SalesLineRec."Amount Including VAT";
                // Stop Sales Header               
                ...
                //             TotalInvoiceAmountWithoutTax_Val += (CustLedgerEntry.Amount - (CustLedgerEntry.Amount * SalesLineRec."VAT %") / 100);
                //         end;
